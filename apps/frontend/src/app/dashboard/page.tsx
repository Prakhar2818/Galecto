  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-4 gap-6 mb-10">
        <StatCard label="Total Throughput" value="1.2M" trend="+12.4%" color="bg-emerald-500" text="text-white" icon={<TrendingUp className="text-white/40" />} />
        <StatCard label="Error Rate" value="0.02%" trend="0.0%" color="bg-white" icon={<AlertTriangle className="text-orange-400" />} />
        <StatCard label="System Integrity" value="99.9%" trend="Secure" color="bg-white" icon={<ShieldAlert className="text-emerald-500" />} />
        <StatCard label="Active Services" value="12" trend="Operational" color="bg-white" icon={<Server className="text-blue-400" />} />
      </div>
