...
class ServiceMapController {
    ...
    async getAnomalyTrends(req, reply) {
        const user = req.user;
        const tenantId = user?.organizationId;
    ...
    async getSloStatus(req, reply) {
        ...
        `,
            ...
            const enriched = sloStatus.map((s) => ({
                ...s,
...
exports.ServiceMapController = ServiceMapController;
